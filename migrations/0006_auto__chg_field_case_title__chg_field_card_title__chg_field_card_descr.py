...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'djecks_case', 'title', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Card.title'
        db.alter_column(u'djecks_card', 'title', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Card.description'
        db.alter_column(u'djecks_card', 'description', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Card.title'
        db.alter_column(u'djecks_card', 'title', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Card.description'
        db.alter_column(u'djecks_card', 'description', self.gf('django.db.models.fields.TextField')(default=''))
